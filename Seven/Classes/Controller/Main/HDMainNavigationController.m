...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    if (self.viewControllers.count > 0) {
        ...
        viewController.navigationItem.leftBarButtonItem = [UIBarButtonItem hd_itemWithTarget:self action:@selector(back) image:@"navigationButtonReturn" highImage:@"navigationButtonReturnClick"];
    }
